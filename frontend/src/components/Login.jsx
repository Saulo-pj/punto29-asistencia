    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white shadow-lg rounded-2xl p-8 w-96">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-green-600 text-white py-2 rounded-md font-semibold hover:bg-green-700 transition" disabled={loading}>
            {loading ? 'Entrando...' : 'Ingresar'}
          </button>

          <p className="text-center text-sm text-gray-500 mt-2 cursor-pointer hover:text-green-600">¿Olvidaste tu contraseña?</p>
        </form>
      </div>
    </div>
  )
